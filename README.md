...
**Today´s Progress:** I started the section about _SQL_ of the Node.js course. I spent a long time trying to install the MySQL on my Windows 7 PC, googled various advice but didn´t succeed. So I tried installing it on the other PC with _Linux_ Mint, which is not supported by the installations, I was partly successful, but got stuck again after starting it. :-( I´m disappointed that after so much time spent I don´t have the things working, but I try to take from it the better part - I _learned to use linux_ a bit. :-D 
